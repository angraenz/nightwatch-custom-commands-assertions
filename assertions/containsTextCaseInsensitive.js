 ...
 *     browser.assert.containsTextCaseInsensitive('#main', 'The Night Watch');
 *   };
 * ```
 *
 * @method containsTextCaseInsensitive
...
exports.assertion = function(definition, expectedText, msg) {
    ...
    this.evaluate = function(value) {
        ...
        return value.toLowerCase().includes(expectedText.toString().toLowerCase());
    };
